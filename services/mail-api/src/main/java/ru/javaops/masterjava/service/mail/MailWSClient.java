...
public class MailWSClient {
    ...
    public static GroupResult sendIndividualMail(final Set<Addressee> to, final String subject, final String body) throws WebStateException {
        ...
        try {
            ...
            log.error("sendIndividualMail failed", e);
            throw WsClient.getWebStateException(e);
        }
